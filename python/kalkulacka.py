...
button_clear = Button(root, text="vymazat", padx=100, pady=20, command=button_clear)
button_multiply = Button(root, text="x", padx=40, pady=20, command=button_multiply)
button_subtrack = Button(root, text="-", padx=40, pady=20, command=button_subtrack)
...
button_subtrack.grid (row=5, column=2)
